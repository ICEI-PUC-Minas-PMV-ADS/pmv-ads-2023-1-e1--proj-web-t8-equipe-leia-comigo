...
var adventuresObject = [
    ...
    },
    {
        ...
        "content": "(Resumo de 'A Recompensa do Soldado') Nesse conto comovente ambientado no pós-guerra, William Faulkner explora as cicatrizes emocionais e dilemas morais enfrentados pelos soldados que retornam para casa. Com descrições vívidas e reflexões profundas, a história mergulha nas consequências da guerra e na busca pela redenção em um mundo para sempre transformado."
    },
    {
        "id": "adventures_4",
        "type": "adventure",
    ...
    },
    {
        ...
        "content": "(Resumo de 'Eu e outras poesias') Augusto dos Anjos convida os leitores a uma jornada pelas profundezas da psique humana, explorando temas de angústia existencial, mortalidade e a dicotomia da vida e da morte. Com seu estilo único e imagens assombrosas, essa coleção de poesias desafia noções convencionais e provoca reflexões sobre as complexidades da existência."
    },
    {
        "id": "adventures_8",
        "type": "adventure",
...
var horrorsObject = [
    {
        ...
        "description": "5 horrors de literatura que você precisa ouvir | Bruna Miranda #445",
    ...
    },
    {
        ...
        "description": "PEDRO LOOS (CIÊNCIA TODO DIA) - Inteligência Ltda. horror #821",
    ...
    },
    {
        ...
        "description": "ENIGMAS DO UNIVERSO: SÉRGIO SACANI E PEDRO PALLOTTA - Inteligência Ltda. horror #789",
    ...
    },
    {
        ...
        "description": "Diário Econômico: horror do Banco Original e Canal Rural - 31/5/2023 | Canal Rural",
    ...
    },
    {
        ...
        "description": "DEBATE: EVOLUCIONISMO X CRIACIONISMO - Inteligência Ltda. horror #829",
...
scrollPerClick_horror = document.querySelector(".img-horrors_0").clientWidth + imagePadding_horrors;
...
scrollPerClick_thrillers = document.querySelector(".img-thrillers_0").clientWidth + imagePadding_thrillers;
